...
CREATE TABLE auth (
  ...
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  UNIQUE KEY auth_email_unique (email, is_deleted),
...
CREATE TABLE follows (
  ...
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  UNIQUE KEY follows_unique_active (follower_id, following_id, is_deleted),
...
CREATE TABLE blocks (
  ...
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  UNIQUE KEY blocks_unique_active (blocker_id, blocked_id, is_deleted),
...
CREATE TABLE likes_posts (
  ...
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  UNIQUE KEY likes_posts_unique_active (post_id, profile_id, is_deleted),
...
CREATE TABLE likes_comments (
  ...
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  UNIQUE KEY likes_comments_unique_active (comment_id, profile_id, is_deleted),
...
CREATE TABLE chats_members (
  ...
  deleted_at TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY chats_members_unique_active (chat_id, profile_id, is_deleted),
...
CREATE TABLE message_read_receipts (
  ...
  deleted_at TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY message_read_receipts_unique_active (message_id, profile_id, is_deleted),
